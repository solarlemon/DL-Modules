...
# 即原Transformer 的position embedding的思想，实现也差不多，但是 generalized to work on images，
# 而且考虑了padding mask前一半是col的，后一半是row的，然后拼起来temperature就是原Transformer paper中的10000
# 跟MAE中用的一样，是在 x, y 方向上分别独立进行位置编码
