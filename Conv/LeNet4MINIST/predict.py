...
# 加载train.py里训练好的模型
model.load_state_dict(torch.load("E:/learn_DeepLearning/modules/Conv/save_model/lenet4mnist.pth"))
...
for i in range(5):
    ...
    with torch.no_grad():
        ...
        # 将 tensor 转化为 Python 列表以便打印
        probabilities_list = probabilities.tolist()
        for i in range(10):
            print(f'{classes[i]}: {probabilities_list[0][i]}')
